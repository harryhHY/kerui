...
Page({
  data: {
    ...
    indicator_dots: true, //swiper指示器
    indicator_color: "#ffffff", //指示点颜色
    indicator_active_color: "#009642", //选中的指示点颜色
    Bannerautoplay: true, //自动播放
  },
  changeData(e) {//新热切换
  ...
  onShow() {
    swan.setPageInfo({
      title: '乐动直播,乐动体育,足球直播,篮球直播,五大联赛直播视频c',
      keywords: '乐动直播,乐动体育,足球直播,篮球直播',
      description: '乐动直播,乐动体育赛事,五大联赛一手新鲜赛事为您呈现',
      articleTitle: '乐动直播,乐动体育赛事,五大联赛一手新鲜赛事为您呈现',
  ...
  getList() {
    swan.request({
      url: apifrom + "/home/listn/m_list_v2",
      header: {
