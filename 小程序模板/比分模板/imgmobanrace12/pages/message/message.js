...
Page({
  ...
  onShow() {
    swan.setPageInfo({
      title: 'imgmobanrace12，各类赛事直播',
      keywords: 'imgmobanrace12,比分直播,JRS直播',
      description: 'imgmobanrace12，各类赛事直播',
      articleTitle: 'imgmobanrace12,发各类赛事直播',
  ...
  gettype() {
    swan.request({
      url: "https://296ff.cn/home/listn/guestbook_type",
      header: {
